...
Responda em texto simples. Não use JSON.`
    ...
    case 'requirements': {
      const all = {
        ...
        tiktok: { media: 'obrigatória', formatos: 'um vídeo ou até 35 fotos', observação: 'vídeo único ou carrossel somente de fotos; vídeos precisam de proporção compatível' },
      }
