const paths = {
  ...
  youtube: { viewBox: '0 0 24 24', color: '#FF0000', d: 'M21.58 7.19a2.51 2.51 0 0 0-1.77-1.78C18.25 5 12 5 12 5s-6.25 0-7.81.41a2.51 2.51 0 0 0-1.77 1.78A26.3 26.3 0 0 0 2 12a26.3 26.3 0 0 0 .42 4.81 2.51 2.51 0 0 0 1.77 1.78C5.75 19 12 19 12 19s6.25 0 7.81-.41a2.51 2.51 0 0 0 1.77-1.78A26.3 26.3 0 0 0 22 12a26.3 26.3 0 0 0-.42-4.81Z' },
  tiktok: { viewBox: '0 0 24 24', color: '#FFFFFF', d: 'M14.5 3h2.4c.16 1.4.9 2.98 2.6 3.68.7.3 1.5.44 2.5.44v2.5c-1.5 0-2.9-.4-4.1-1.16v6.16a5.98 5.98 0 1 1-6-6c.2 0 .4 0 .6.03v2.55a3.4 3.4 0 1 0 2.4 3.25V3Z' },
...
export function PlatformIcon({ platform, className = 'h-3.5 w-3.5' }) {
  ...
  return (
    <svg viewBox={icon.viewBox} className={className} fill={icon.color} aria-hidden="true">
      {key === 'youtube' ? <>
        <path d={icon.d} />
        <path fill="#FFFFFF" d="m10 8.5 6 3.5-6 3.5v-7Z" />
      </> : key === 'tiktok' ? <>
        <path fill="#FF0050" transform="translate(-.8 .55)" d={icon.d} />
        <path fill="#25F4EE" transform="translate(.8 -.55)" d={icon.d} />
