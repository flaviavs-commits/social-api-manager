...
export function SchedulerPage() {
  ...
  return <section className="page-view"><section className="panel"><p className="eyebrow">PUBLICAÇÃO</p><h2>{publishNow ? 'Publicar agora' : 'Agendar publicação'}</h2><form className="draft-form sched-form" onSubmit={submit}>
    ...
    <fieldset className="sched-section"><legend className="sched-section-title"><span className="sched-section-num">1</span> Plataformas</legend><div className="platform-options">{platforms.map(platform => <label key={platform}><input type="checkbox" checked={selected.includes(platform)} onChange={() => toggle(platform)}/>{platform}</label>)}</div></fieldset>

    <fieldset className="sched-section"><legend className="sched-section-title"><span className="sched-section-num">2</span> Conteúdo</legend>
    ...
    <fieldset className="sched-section"><legend className="sched-section-title"><span className="sched-section-num">3</span> Configurações por rede</legend><div className="advanced-options">
    ...
    <fieldset className="sched-section"><legend className="sched-section-title"><span className="sched-section-num">4</span> Agendamento</legend>
