...
const TIERS = [
  {
    id: 'gratuito',
    name: 'Gratuito',
    description: 'Para começar a organizar sua presença digital.',
    price: 'Grátis',
    features: ['Agendamento de publicações', 'Conexão com suas redes', 'Acompanhamento de métricas'],
    cta: 'Começar grátis',
  },
  {
    id: 'criador',
    name: 'Criador',
    description: 'Mais ritmo e inteligência para quem publica com frequência.',
    price: 'Para crescer',
    features: ['Tudo do plano Gratuito', 'IA para ideias e conteúdo', 'Biblioteca de mídia e filas'],
