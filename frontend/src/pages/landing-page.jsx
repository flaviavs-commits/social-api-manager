...
export function LandingPage() {
  ...
  return <main className="landing-page" id="inicio">
    ...
    <section className="landing-platform-section landing-container" id="plataforma"><div className="landing-section-kicker">MEUECOOMÍDIA: VISÃO GERAL</div><h2>Uma plataforma inteira,<br /><em>em um só painel.</em></h2><p className="landing-platform-intro">Gerencie Instagram, Facebook, TikTok e YouTube sem alternar entre aplicativos. Planeje, publique, analise e converse com sua audiência no mesmo fluxo.</p><div className="platform-overview-shot"><div className="platform-overview-top"><div><span className="platform-overview-logo"><img src={logoIcon} alt="" /></span><b>MeuEcooMídia</b></div><div><span>Instagram</span><span>Facebook</span><span>TikTok</span><span>YouTube</span></div><strong>MA</strong></div><div className="platform-overview-body"><aside><b>PAINEL</b><span className="active"><Icon name="eye" size={13} /> Visão geral</span><span><Icon name="calendar" size={13} /> Calendário</span><span><Icon name="sparkle" size={13} /> Assistente IA</span><span><Icon name="chart" size={13} /> Analytics</span><b>RELACIONAMENTO</b><span><Icon name="message" size={13} /> Inbox</span><span><Icon name="link" size={13} /> Smartlink</span></aside><div className="platform-overview-content"><div className="platform-overview-heading"><div><small>VISÃO CONSOLIDADA</small><h3>Bom dia, Mariana 👋</h3></div><span>Últimos 30 dias⌄</span></div><div className="platform-overview-cards"><div><small>Visualizações</small><strong>48,6 mil</strong><em>↗ 28%</em></div><div><small>Interações</small><strong>3.842</strong><em>↗ 17%</em></div><div><small>Novos seguidores</small><strong>+1.274</strong><em>↗ 32%</em></div></div><div className="platform-overview-lower"><div className="platform-overview-graph"><b>Crescimento da audiência</b><div><i /><i /><i /><i /><i /><i /><i /><i /><i /><i /></div></div><div className="platform-overview-ai"><span><Icon name="sparkle" size={14} /></span><p><b>Leitura da IA</b> Seus Reels tiveram mais alcance esta semana.</p></div></div></div></div></div>
    <div className="landing-capability-grid"><article className="landing-capability-card landing-capability-card--wide"><div className="landing-capability-copy"><FeatureIcon name="calendar" /><h3>Agendamento e publicação multiplataforma.</h3><p>Prepare posts, descrições e mídias, publique em todas as redes conectadas ou escolha os canais. O sistema adapta o conteúdo às regras de cada plataforma.</p><ul><li>Melhores horários sugeridos pela IA</li><li>Publicações recorrentes e duplicação de sucesso</li><li>Calendário com tudo publicado e programado</li></ul></div><PlatformScreenshot type="planner" /></article><article className="landing-capability-card"><div className="landing-capability-copy"><FeatureIcon name="folder" tone="pink" /><h3>Gestão de ativos.</h3><p>Guarde rascunhos, textos, hashtags e imagens em uma biblioteca organizada por pastas.</p></div><PlatformScreenshot type="assets" /></article><article className="landing-capability-card"><div className="landing-capability-copy"><FeatureIcon name="sparkle" tone="purple" /><h3>Assistente de IA avançado.</h3><p>Transforme uma ideia em posts prontos, peça ajustes em linguagem natural e receba leituras coerentes com o contexto do seu negócio.</p><ul><li>Baú de ideias com 3 sugestões</li><li>Análise visual, contextual e tradução de métricas</li></ul></div><PlatformScreenshot type="ai" /></article><article className="landing-capability-card landing-capability-card--wide"><div className="landing-capability-copy"><FeatureIcon name="chart" tone="blue" /><h3>Análise de desempenho e audiência.</h3><p>Monitore cada rede em uma visão unificada ou filtre por plataforma. Entenda quem é sua audiência e o que fazer em seguida.</p><ul><li>Dados demográficos e melhores dias e horários</li><li>Relatórios em PDF programados por e-mail</li></ul></div><PlatformScreenshot type="analytics" /></article><article className="landing-capability-card"><div className="landing-capability-copy"><FeatureIcon name="message" tone="pink" /><h3>Engajamento e conversão.</h3><p>Responda comentários do Instagram, Facebook e YouTube no Inbox e reúna seus links em uma página para a Bio.</p></div><PlatformScreenshot type="engagement" /></article><article className="landing-capability-card"><div className="landing-capability-copy"><FeatureIcon name="shield" tone="blue" /><h3>Segurança de alto nível.</h3><p>2FA, login via Google, gestão transparente das redes conectadas e chaves de acesso para integrações externas.</p></div><PlatformScreenshot type="security" /></article></div></section>
